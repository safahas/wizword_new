...
def _build_prompt(doc_text: str, count: int) -> dict:
    ...
    user = (
        ...
        "   - Prefer nouns/proper nouns and domain terms; include key multi-syllable terms if present.\n"
        ...
        "   - Keep hints short and distinct; avoid generic dictionary-like wording.\n"
